    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_nivel.php?id=<?php echo $nivel['cod_nivel_acad']; ?>" class="btn btn-warning btn-sm">Modificar</a>
                    <a href="delete_nivel.php?id=<?php echo $nivel['cod_nivel_acad']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este registro?');">Eliminar</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
